...
@section('title', 'FloodRescue | Peta Wilayah')

@section('content')
<!-- Map Container -->
<div class="relative w-full h-screen" id="map-container" style="font-family: 'Poppins', sans-serif;">
  <header class="w-full z-40 bg-white bg-opacity-90 shadow-md py-2 px-6 flex items-center justify-between absolute left-0 rounded-t-xl">
    <h1 class="text-xl font-semibold text-blue-900 tracking-wide">Peta Wilayah Rawan Banjir</h1>
    <div class="text-sm text-gray-600 hidden md:block">
      FloodRescue &mdash; Indonesia Flood Risk Visualization
    </div>
  </header>
  <!-- Map -->
