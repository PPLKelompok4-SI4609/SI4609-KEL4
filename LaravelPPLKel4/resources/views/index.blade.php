<html lang="en">
 ...
 <body>
  <!-- Navbar -->
  <nav>
   <div aria-label="Primary Navigation" class="nav-container" role="navigation">
    <a aria-label="FloodRescue Home" class="logo" href="/">
     <img
       alt="Yellow sun icon representing logo"
       height="20"
       src="https://storage.googleapis.com/a1aa/image/e61fea9a-dc5b-4ed6-d287-76d4baf05424.jpg"
       width="20"
     />
     LOGO
    </a>
    <div class="nav-links" role="list">
     <a href="/" role="listitem" tabindex="0">Home</a>
     <a href="/discover" role="listitem" tabindex="0">Discover</a>
     <a href="/blog" role="listitem" tabindex="0">Blog</a>
     <a href="/about" role="listitem" tabindex="0">About Us</a>
     <a href="/contact" role="listitem" tabindex="0">Contact</a>
    </div>
    <div
      aria-controls="search-box-container"
      aria-expanded="false"
      aria-haspopup="true"
  ...
  <main>
   ...
   <section id="hero" style="background: {{ $bgGradient }};">
    ...
    <div class="content text-white max-w-4xl mx-auto">
     <h1
       class="font-extrabold text-5xl sm:text-7xl mb-4 drop-shadow-lg"
       style="font-weight:700;"
     >
      {{ $city }}
     </h1>
     <p
       class="text-sm sm:text-base font-semibold mb-6 drop-shadow-md"
     ...
     />
     <p
       class="text-5xl font-extrabold mt-4 drop-shadow-lg"
       style="font-weight:700;"
     >
     ...
     <p
       class="text-xl font-semibold mt-2 drop-shadow-md"
       style="font-weight:600;"
     >
   ...
   <section aria-label="Forecast and Flood Risk" id="forecast-flood-container">
    ...
    <div aria-labelledby="btn-daily" class="forecast-container" id="daily" role="tabpanel">
     ...
     <div class="forecast">
      ...
      <div class="forecast-day" tabindex="0">
       ...
       <p>
        Rain:
        {{ isset($day['rain']['3h']) ? $day['rain']['3h'] . ' mm' : 'No rain' }}
       </p>
      </div>
      @endforeach
     </div>
    ...
    <div
      aria-labelledby="btn-weekly"
      class="forecast-container hidden"
      id="weekly"
      role="tabpanel"
    >
     <!-- Weekly Forecast -->
    ...
    @if(isset($floodRisk))
    <section
      aria-label="Flood Risk Prediction"
      id="flood-risk"
      role="region"
      class="@if($floodRisk === 'High') high @elseif($floodRisk === 'Medium') medium @else low @endif"
    >
     <h2>
      Flood Risk Prediction
      @if($floodRisk === 'High')
      <i
        class="fas fa-exclamation-triangle text-red-600 ml-2"
        aria-hidden="true"
      ></i>
      @elseif($floodRisk === 'Medium')
      <i
        class="fas fa-exclamation-circle text-orange-600 ml-2"
        aria-hidden="true"
      ></i>
      @else
     ...
     <p>
      Flood Risk in
      <strong>{{ $city }}</strong>:
      <span style="font-weight:700; color:#22c55e;">{{ $floodRisk }}</span>
     </p>
     <p>
      Rainfall Level:
      {{ $floodRisk === "High"
        ? "≥ 100mm"
        : ($floodRisk === "Medium" ? "50-99mm" : "< 50mm") }}
     </p>
     @if($floodRisk === "High")
     <p class="important text-red-700">
      <i class="fas fa-bell mr-2" aria-hidden="true"></i>
      Prepare for potential flooding, stay updated with local authorities and
      warnings.
     </p>
     @elseif($floodRisk === "Medium")
   ...
   <section aria-label="Top Cities" id="top-cities">
    ...
    <div class="grid" role="list">
     <a class="city-card" href="/?city=New York" role="listitem" title="New York">
      <img
     ...
     <a class="city-card" href="/?city=London" role="listitem" title="London">
      <img
     ...
     <a class="city-card" href="/?city=Tokyo" role="listitem" title="Tokyo">
      <img
        alt="Flag of Japan"
        height="38"
        loading="lazy"
     ...
     <a class="city-card" href="/?city=Sydney" role="listitem" title="Sydney">
      <img
     ...
     <a class="city-card" href="/?city=Paris" role="listitem" title="Paris">
      <img
        alt="Flag of France"
        height="38"
        loading="lazy"
     ...
     <a class="city-card" href="/?city=Berlin" role="listitem" title="Berlin">
      <img
        alt="Flag of Germany"
        height="38"
        loading="lazy"
     ...
     <a class="city-card" href="/?city=Hanoi" role="listitem" title="Hanoi">
      <img
        alt="Flag of Vietnam"
        height="38"
        loading="lazy"
     ...
     <a class="city-card" href="/?city=Toronto" role="listitem" title="Toronto">
      <img
        alt="Flag of Canada"
        height="38"
        loading="lazy"
     ...
     <a class="city-card" href="/?city=Dubai" role="listitem" title="Dubai">
      <img
