<?php $__env->startSection('title', 'FloodRescue | Layanan Pasca Banjir'); ?>
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-md text-center p-8 hover:-translate-y-2 transition">
                <img src="<?php echo e(asset('images/' . $service['icon'])); ?>" alt="<?php echo e($service['title']); ?>" class="mx-auto mb-4 w-16 h-16">
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-md p-6 text-center hover:-translate-y-2 transition">
                <img src="<?php echo e(asset('images/' . $t['img'])); ?>" alt="<?php echo e($t['name']); ?>" class="w-16 h-16 rounded-full object-cover mx-auto mb-4">
                <h3 class="text-xl font-semibold mb-2"><?php echo e($t['name']); ?></h3>
                <p class="text-gray-600 text-sm"><?php echo e($t['text']); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Documents\GitHub\SI4609-KEL4\LaravelPPLKel4\resources\views/pasca-banjir/index.blade.php ENDPATH**/ ?>