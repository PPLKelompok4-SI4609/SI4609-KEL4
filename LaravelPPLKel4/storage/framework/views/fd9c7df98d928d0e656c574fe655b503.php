<nav class="bg-white shadow">
    <div class="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <ul class="hidden md:flex space-x-6 text-gray-700 font-medium">
            ...
            <li>
                <a href="/pasca-banjir"
                class="<?php echo e(Request::is('pasca-banjir') ? 'text-blue-700 font-semibold' : 'text-gray-700 hover: hover:text-blue-600'); ?>">
                Layanan Pasca Banjir
                </a>
            </li>
            <li>
                <a href="/laporan-banjir"
                class="<?php echo e(Request::is('laporan-banjir') || Request::is('status-laporan') ? 'text-blue-700 font-semibold' : 'text-gray-700 hover: hover:text-blue-600'); ?>">
                Form Laporan Banjir
                </a>
            </li>
            <li>
...
<?php /**PATH D:\SI4609-KEL4\LaravelPPLKel4\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>