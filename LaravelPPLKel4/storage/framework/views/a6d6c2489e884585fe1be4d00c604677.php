...
<body class="bg-white text-gray-900">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-8 pb-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <article class="space-y-3">
      <img alt="<?php echo e($article->title); ?>" class="w-full h-48 object-cover" src="<?php echo e($article->image_url); ?>" />
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\FloodPPL\AppFlood\LaravelPPLKel4\resources\views/articles/index.blade.php ENDPATH**/ ?>