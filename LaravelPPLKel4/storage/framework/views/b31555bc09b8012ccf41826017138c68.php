...
<div class="flex justify-center items-center min-h-[80vh]">
    ...
    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="FloodRescue Logo" class="h-32 mx-auto mb-4">
        ...
        <form method="POST" action="<?php echo e(route('register')); ?>">
            ...
            <div class="mb-4">
                ...
                <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                    class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 <?php $__errorArgs = ['name'];
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\SI4609-KEL4\LaravelPPLKel4\resources\views/auth/register.blade.php ENDPATH**/ ?>