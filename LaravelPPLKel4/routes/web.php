...
// Payment routes
Route::get('/payment', [DonationController::class, 'showPaymentForm'])->middleware(['auth', 'role:user', '2fa'])->name('payment.form');
Route::post('/payment', [DonationController::class, 'processPayment'])->middleware(['auth', 'role:user', '2fa'])->name('payment.process');

// Donation Tracking route
Route::get('/donasi/tracking/{donation_id}', [DonationController::class, 'showTracking'])->middleware(['auth', 'role:user', '2fa'])->name('donasi.tracking');
